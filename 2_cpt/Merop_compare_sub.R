...
n_subjects = c(20, 50, 100, 200, 500) # Different sample size scenarios
n_subjects = c(100, 200, 1000) # Focused on larger sample sizes for better convergence
n_timepoints = 12
n_reps <- 2
  ...
  tryCatch({
    ...
    fit_covar <- tryCatch(
      admr::fitMC(
        ...
        maxiter = 8000,  # Maximum iterations
        use_grad = T
      ), error = function(e) NULL)
